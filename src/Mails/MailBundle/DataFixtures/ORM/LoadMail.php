    ...
    public function load(ObjectManager $manager)
    {
        ...
        foreach ($listNames as $name) {
          ...
          //------------------------------------------------------------------------
            ...
            //MAIL SENT 1
            $mailsent1 = new MailSent(['user'=> $acteur_0, 'actor'=> $acteur_3]);
        $manager->persist($mailsent1);
            
            //MAIL 1
            $mail1 = new Mail(['reference'=> 'CDEP0001', 'objet' => 'Welcome', 'nombrePiecesJointes' => 1,
            'received'=> false, 'mailsent' => $mailsent1]);
        $manager->persist($mail1);
            
            //----------------------------------------------------

            //MAIL SENT 2
            $mailsent2 = new MailSent(['user'=> $acteur_1, 'actor'=> $acteur_4, ]);
        ...
        $manager->persist($mailreceived3);
            ...
            //MAIL 6
            $mail6 = new Mail(['reference'          => 'CARR0003', 'objet'               => 'Quelle chaleur!',
                                //'dateEdition'         => new \Datetime("now", new \DateTimeZone('Africa/Abidjan')),
                                //'dateEnvoi'           => new \Datetime("now", new \DateTimeZone('Africa/Abidjan')),
                                'nombrePiecesJointes' => 6,
                                'received'            => true,
